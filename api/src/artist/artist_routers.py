...
from src.artist.services.artist_service import get_artists_data_and_total, get_artists_data, get_image_data, get_image_type, get_video_data
...
def get_image(path:str, is_thumbnail:bool=False, is_sample:bool=False):
    ...
    if mime.startswith("image/"):
        content = get_image_data(image_path, is_thumbnail)
    elif mime.startswith("video/"):
        content = get_video_data(image_path, is_thumbnail)
        if is_thumbnail: mime = "image/png"
    else:
        content = None
