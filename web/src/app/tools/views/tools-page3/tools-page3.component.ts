...
@Component({
  ...
  templateUrl: './tools-page3.component.html'
})
export class ToolsPage3Component implements AfterViewChecked, AfterViewInit, OnDestroy {
  ...
  search() {
    ...
    this.apiService.searchDanbooruByTag(this.strInput, this.pageInput).subscribe({
